...
def rotate_slow(z, angle, xcntr, ycntr, cval=0.0):
    ...
    try:
     ...
     pass
#    hdu = fits.PrimaryHDU(y-xcntr)
#    hdu.writeto('xnorm.fits')
#    hdu = fits.PrimaryHDU(ry)
...
#f = fits.open('/home/vinu/test-pymorph/rewriting-pymorph-test/00018611_serexp.fits')
#z = f[0].data
#f.close()
